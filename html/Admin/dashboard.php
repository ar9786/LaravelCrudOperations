<?php include 'include/header.php'; ?>
      <div class="content page_data">
        <div class="mb-5 clearfix">
          <p class="mb-0 fz35 pt-3">Athletes</p>
        </div>
              ...
              <table class="table">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="text-center">20/01/2019</td>
                    ...
                    <tr>
                        ...
                        <td class="text-center">smith@gmail.com</td>
                        <td class="text-center">12/07/2018</td>
                        <td class="td-actions text-center">
                            <button type="button" class="btn btn-info pt-2 pb-2 pl-3 pr-3">
                                Enable
                            </button>
                    ...
                    <tr>
                        ...
                        <td class="text-center">rock@gmail.com</td>
                        <td class="text-center">27/07/2011</td>
                        <td class="td-actions text-center">
                            <button type="button" class="btn btn-info pt-2 pb-2 pl-3 pr-3">
                                Disable
                            </button>
                    ...
                    <tr>
                        ...
                        <td class="text-center">marvel@gmail.com</td>
                        <td class="text-center">18/12/2012</td>
                        <td class="td-actions text-center">
                            <button type="button" class="btn btn-info pt-2 pb-2 pl-3 pr-3">
                                Enable
                            </button>
